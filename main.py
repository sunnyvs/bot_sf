...
predictions = [
    ...
    'найдёшь в куртке 100 рублей',
    'звёзды говорят, что стоит посмотреть фильмы с друзьями',
    'stay true\nstay you',
    'прокачивай финансовый интеллект и купи активы',
    'любой конец это хорошее начало',
    'УРААААААА ЖЕНЩИНЫ С ВОСЬМЫМ МАРТОЙ',
    'УРААААААА ЖЕНЩИНЫ С ВОСЬМЫМ МАРТОЙ',
    'УРААААААА ЖЕНЩИНЫ С ВОСЬМЫМ МАРТОЙ',
    'УРААААААА ЖЕНЩИНЫ С ВОСЬМЫМ МАРТОЙ',
    'УРААААААА ЖЕНЩИНЫ С ВОСЬМЫМ МАРТОЙ',
